...
const Projects = (props: Props) => {
    const projects = [
        ...
        },
        {
            id:2,
            name:"Sumex",
            summary:"Sumex is an AI-powered article summarizer that aims to revolutionize the way we consume and process information. With its advanced natural language processing algorithms, Sumex can analyze and condense lengthy articles into concise and coherent summaries, saving users valuable time and effort.",
            image:mock2
        },
        {
            id:3,
            name:"GPT-3",
            summary:"The GPT-3 project is a frontend design showcase that highlights the skills and creativity in designing and implementing user interfaces.The project's emphasis is on presenting visually appealing and user-friendly interfaces. It demonstrates the developer's proficiency in frontend technologies, such as HTML, CSS, JavaScript and React.js for enhanced functionality and styling.",
            image:mock3
        },
        {
            id:4,
        ...
        snap-x snap-mandatory z-20 scrollbar-thin  scrollbar-track-gray-400/20 scrollbar-thumb-orange-400'>
            {projects.map((project,i)=> (
                ...
                justify-center p-20 md:pb-0 h-screen'>
                    ...
                    viewport={{ once:true }}
                    src={project.image?.src} alt="mockup" />
                ...
                <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                    ...
                    <div className='flex space-x-2 justify-center mt-2'>
                        <p className='flex justify-center text-center mt-2'>Tech Stack :</p>
                <img className='h-10 w-10 rounded-full' src={project.stack?.[1]} alt="" />
                <img className='h-10 w-10 rounded-full' src={project.stack?.[2]} alt="" />
